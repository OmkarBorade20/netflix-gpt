  ...
  return (
    <div className="">
      ...
      <form
        ...
        className="w-[500px] absolute bg-black my-48 ml-[600px] text-white  p-12 opacity-80 rounded-xl"
      >
        ...
        {!isSignin ? (
          <input
            ref={name}
            className="w-full p-4 my-6 bg-gray-700"
            type="text"
        ...
        />
        {errorMessage && (
          <p className="p-2 my-2 text-red-500 font-bold ">{errorMessage}</p>
        )}
        <button
          onClick={handelclick}
        ...
        <p
          onClick={toggleBtn}
          className="font-bold text-lg my-3 p-4 cursor-pointer"
        >
          {isSignin
